    ...
    public class NnCam : IDisposable
    {
        ...
        public enum eOPTION : uint
        {
            ...
            OPTION_TESTPATTERN       = 0x28, /* test pattern:
                                             ...
                                             */
            OPTION_AUTOEXP_THRESHOLD = 0x29  /* threshold of auto exposure, default value: 5, range = [5, 15] */
        };
        ...
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl), Obsolete("Use Nncam_EnumV2")]
        private static extern uint Nncam_Enum(IntPtr ti);
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        private static extern uint Nncam_EnumV2(IntPtr ti);
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        private static extern SafeCamHandle Nncam_Open([MarshalAs(UnmanagedType.LPStr)] string id);
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        ...
        */
        ...
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Nncam_FfcExport(SafeCamHandle h, [MarshalAs(UnmanagedType.LPStr)] string filepath);
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Nncam_FfcImport(SafeCamHandle h, [MarshalAs(UnmanagedType.LPStr)] string filepath);
        [DllImport("libnncam.so", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
            ...
            if (cnt > 0)
            {
                ...
                for (uint i = 0; i < cnt; ++i)
                {
...

                    {
                        ...
                        q += IntPtr.Size;
                        //no skip 4 bytes, different from the windows version
